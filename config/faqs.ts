export const FAQS_EN = [
  ...
  {
    title: "How does the Red Note Slang Translator work?",
    content:
      "Users can quickly and accurately parse various slang, abbreviations, and jargon on Red Note through the input box. It provides detailed explanations, example sentences, and sources, making it more efficient for users to understand. It also includes a convenient list of trending terms.",
  },
  {
    title: "How to use the search function?",
    content:
      "Enter the slang, abbreviation, or jargon you want to search for into the input box. The system will provide fuzzy matching and automatic completion. The search results include meanings, usage, context, example sentences, sources, and related terms. It’s Easy and Convenient to use.",
  },
  {
    title: "What are trending terms?",
    content:
      "The trending terms are updated daily, reflecting the latest trends on Red Note. They are categorized by topic and type, allowing users to find the information they need more effectively. This makes it more Effective for users.",
  },
  {
    title: "Can I contribute to the translator?",
    content:
      "Yes, users can submit new slang they have discovered, along with explanations and example sentences. The submissions will be reviewed by administrators. This feature is very Practical and makes the translator more Comprehensive.",
  },
];
...
export const FAQS_ZH = [
  {
    title: "什么是红薯俚语翻译器？",
    content:
      "红薯俚语翻译器旨在解决用户理解小红书平台上新兴俚语、黑话和缩写等表达方式的难题。它能帮助用户更好地融入社区，并提升浏览体验。它易于上手，而且非常轻量。",
  },
  {
    title: "红薯俚语翻译器是如何工作的？",
    content:
      "用户可以通过输入框快速准确地解析小红书上的各种俚语、缩写和黑话。它提供详细的解释、例句和来源，使用户能够更高效地理解。此外，它还包括一个便捷的流行语列表，使用户能够更高效的获取信息。",
  },
  {
    title: "如何使用搜索功能？",
    content:
      "在输入框中输入您想要搜索的俚语、缩写或黑话。系统将提供模糊匹配和自动补全功能。搜索结果包括含义、用法、语境、例句、来源和相关词汇。使用起来非常方便和简单。",
  },
  {
    title: "什么是热门词语？",
    content:
      "热门词语每日更新，反映小红书上的最新趋势。它们按主题和类型分类，使用户能够更有效地找到所需信息。这使得用户获取信息更加高效。",
  },
  {
    title: "我可以为翻译器做出贡献吗？",
    content:
      "是的，用户可以提交他们发现的新俚语，并附上解释和例句。提交的内容将由管理员审核。此功能非常实用，并使翻译器更加全面。",
  },
];
